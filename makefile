...
baulkmake: main.o graphics.o game.o input.o sprite.o
	$(CC) $(CFLAGS) $(INCLUDES) -o baulkmake main.o graphics.o game.o input.o sprite.o $(SDL_CFLAGS) $(SDL_LDFLAGS) -lSDL2_image
